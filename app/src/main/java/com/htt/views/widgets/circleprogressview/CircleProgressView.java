package com.htt.views.widgets.circleprogressview;
...
public class CircleProgressView extends View {
    ...
    private void initAttributes(AttributeSet attrs, int defStyle)
    {
        ...
        currentProgress = a.getFloat(R.styleable.CircleProgressView_cpv_progress,
                resources.getInteger(R.integer.cpv_default_progress));
        maxProgress = a.getFloat(R.styleable.CircleProgressView_cpv_maxProgress,
                resources.getInteger(R.integer.cpv_default_max_progress));
        thickness = a.getDimensionPixelSize(R.styleable.CircleProgressView_cpv_thickness,
                resources.getDimensionPixelSize(R.dimen.cpv_default_thickness));
        isIndeterminate = a.getBoolean(R.styleable.CircleProgressView_cpv_indeterminate,
                resources.getBoolean(R.bool.cpv_default_is_indeterminate));
        autostartAnimation = a.getBoolean(R.styleable.CircleProgressView_cpv_animAutostart,
                resources.getBoolean(R.bool.cpv_default_anim_autostart));
        initialStartAngle = a.getFloat(R.styleable.CircleProgressView_cpv_startAngle,
        ...
        if (a.hasValue(R.styleable.CircleProgressView_cpv_color)) {
            color = a.getColor(R.styleable.CircleProgressView_cpv_color, resources.getColor(R.color.cpv_default_color));
        }
        ...
        animDuration = a.getInteger(R.styleable.CircleProgressView_cpv_animDuration,
                resources.getInteger(R.integer.cpv_default_anim_duration));
        animSwoopDuration = a.getInteger(R.styleable.CircleProgressView_cpv_animSwoopDuration,
                resources.getInteger(R.integer.cpv_default_anim_swoop_duration));
        animSyncDuration = a.getInteger(R.styleable.CircleProgressView_cpv_animSyncDuration,
                resources.getInteger(R.integer.cpv_default_anim_sync_duration));
        animSteps = a.getInteger(R.styleable.CircleProgressView_cpv_animSteps,
